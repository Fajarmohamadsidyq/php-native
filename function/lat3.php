        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="hobi[]" value="Belajar Karate"> Karate <br>
                    <input type="checkbox" name="hobi[]" value="Belajar Kung Fu"> Kung Fu <br>
                    <input type="checkbox" name="hobi[]" value="Balapan"> Balap <br>
                    <input type="checkbox" name="hobi[]" value="Bermain Game"> Maen Game <br>
                </td>
            </tr>
            <tr>
                <td>
